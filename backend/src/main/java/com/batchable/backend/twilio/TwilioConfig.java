...
/**
 * Configures and initializes the Twilio SDK using credentials from application properties.
 * Active for all profiles except "test" so tests do not require real Twilio credentials.
 */
@Profile("!test")
@Configuration
