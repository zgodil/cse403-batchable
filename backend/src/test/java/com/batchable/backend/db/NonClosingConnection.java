...
/**
 * Connection wrapper that delegates everything except close(),
 * so DAOs can safely use try-with-resources without killing the shared test connection.
 */
public final class NonClosingConnection implements Connection {
