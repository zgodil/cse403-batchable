...
# Only use one configuration at a time
...
1. Run `ssh root@batchable.org` (from anywhere), and enter the password.
...
[https://console.twilio.com/us1/develop/sms/virtual-phone](https://console.twilio.com/us1/develop/sms/virtual-phone)

1. On the Virtual Phone page, locate the **phone number selector** near the top right of the interface.
2. Click the dropdown menu and select the **available phone number** (there is currently only one configured number).
